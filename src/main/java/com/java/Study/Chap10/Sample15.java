...
public class Sample15 {
	...
	/*
	 * <?extends 상위 클래스>:상위 클래스를 상속 박은 자료형으로 제한 
	 * <? super 하위 클래스>:하위 클래스가 상속 받고 있는 상위클래스 자료형으로 제한
	 */	
	public static void main(String[] args) {
		Group<Pet> petGroup = new Group<>();
		petGroup.add(new  Pet("앵무새"));
		petGroup.add(new  Pet("십지매"));
	...
	public static void getAnimal(Group<? extends Animal>group) {
